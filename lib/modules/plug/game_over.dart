    ...
    return Scaffold(
      body: Container(
        ...
        child: Column(
          ...
          children: <Widget>[
            const Text('Game Over', style: TextStyle(color: Colors.redAccent, fontSize: 50.0, fontWeight: FontWeight.bold, fontStyle: FontStyle.italic, shadows: [
                Shadow( // bottomLeft
            ...
            ElevatedButton(
              ...
              child: const Row(
                ...
                children: [
                  ...
                  Text("Try Again", style: TextStyle(color: Colors.white, fontSize: 20.0))
                ],
              ),
            ),
          ],
